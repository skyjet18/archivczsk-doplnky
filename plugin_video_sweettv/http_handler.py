...
class SweetTVHTTPRequestHandler(PlayliveTVHTTPRequestHandler, HlsHTTPRequestHandler):
	def __init__(self, content_provider, addon ):
		super(SweetTVHTTPRequestHandler, self).__init__(content_provider, addon)
		self.cache_life = 0
